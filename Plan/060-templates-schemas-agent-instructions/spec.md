...
- `Plan/031-skills-progressive-disclosure/spec.md` — `SkillDoc` +
  `WalkerSkills` precedent (the parallel pattern that works today).
- `Plan/032-templates-schemas-oop-extensions/spec.md` — the parent
  spec (this one supersedes its missing 30%; preserves what shipped).
- `Plan/028-jules-folder-migration/` — absorbed: 060 ships the folder
...
- `Plan/045-reflect-semantic-recall/spec.md` — `plan_slug` property
