...
- [ ] Update `Plan/032-templates-schemas-oop-extensions/spec.md` frontmatter: `status: complete` with changelog block.
- [ ] Update `Plan/004-template-schema-coverage/spec.md` frontmatter: `status: superseded` referencing Spec 032.
...
**Plan complete and saved to `Plan/032-templates-schemas-oop-extensions/`. Two execution options:**
