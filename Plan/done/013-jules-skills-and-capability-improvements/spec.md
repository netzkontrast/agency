...
- **Create** (in `Plan/inprogress/013-jules-skills-and-capability-improvements/`):
...
- `Plan/inprogress/012-jules-complete-lifecycle-and-watcher/spec.md` + `REVIEW.md` +
...
### Done
- Phase A (research): `RESEARCH-tools.md`, `RESEARCH-operational.md`, `RESEARCH-skills.md` all present in `Plan/inprogress/013-jules-skills-and-capability-improvements/`
