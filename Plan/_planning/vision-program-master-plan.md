...
- **289** sqlmodel-entity-store — built Slice 1 on #141 (refactor agent, user-directed; typed entities derived from the ontology, `table=False`).
- **290** Management capability — drafted (Phase A; renumbered 288→289→290 after a double-yield collision with sqlmodel-entity-store), build deferred (feature work).
