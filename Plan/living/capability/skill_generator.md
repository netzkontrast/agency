...
|---|---|---|---|
| `skill_generator.generate` | act | **name** · **description** · **body** | Author a SKILL.md and lint it against the CSO rules; flag if not deploy-ready. |
...
<!-- doc-source: agency/capabilities/skill_generator -->
