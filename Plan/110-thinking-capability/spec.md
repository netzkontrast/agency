...
source-material:
  ...
  - "Plan/101-novel-complete-build/CRITICAL-ANALYSIS.md (iter-12 application of the 8 methods to the novel spec set — proves the methods compose across domains)"
