...
- body: links to `Plan/029-mcp-bootstrap-and-self-explain/spec.md`, names the closed Fehlerbericht findings (F1/F4/F6), notes deferred items (F2 → Spec 030, F3 → Spec 031).
