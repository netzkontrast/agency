...
- `Plan/inprogress/012-jules-complete-lifecycle-and-watcher/spec.md` (the watcher
  + per-intent queue this spec extends with the side-channel emit).
- `Plan/inprogress/013-jules-skills-and-capability-improvements/DESIGN.md` (the
  INSTRUCTIONS template strings this spec reuses for the
  monitor.message body).
- `Plan/inprogress/021-engine-monitor-channel/spec.md` (the substrate).
