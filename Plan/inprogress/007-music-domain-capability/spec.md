...
- `/home/user/agency/Plan/inprogress/002-boundary-driver-protocol/spec.md:99-109, :244-288` —
...
- commits/notes: `5a4263b` "move the music domain demo out of core into examples/" (the original extraction); Spec 002 (`Plan/inprogress/002-boundary-driver-protocol/spec.md`) remains `status: draft`, confirming the driver injection blocker is unresolved.
