...
- **Create:**
  ...
  - `Plan/inprogress/023-adaptive-disclosure/IMPLEMENTATION-PLAN.md` — Workflow output.
- **Modify:**
...
- `Plan/inprogress/016-capability-authoring-doctrine/spec.md:217-242` — Hint #7
  (docstring contract) — the cleavage points Spec 023 reads.
- `Plan/inprogress/018-cli-token-efficiency-bundle/` — overlaps; this spec subsumes
  most of 018.
- `Plan/inprogress/019-engine-output-shape-contract/` — codifies the new delta shape.
