...
- New: `Plan/inprogress/031-skills-progressive-disclosure/spec.md` — already written.
...
See `Plan/superseded/032-templates-schemas-oop-extensions/IMPLEMENTATION-PLAN.md` Task 1.2 for the file-based emission.
...
- [ ] Update `Plan/inprogress/031-skills-progressive-disclosure/spec.md` frontmatter: `status: complete` with a changelog block listing the implementing commit SHAs (Spec 016 pattern).
...
**Plan complete and saved to `Plan/inprogress/031-skills-progressive-disclosure/`. Two execution options:**
