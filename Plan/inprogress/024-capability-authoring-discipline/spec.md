...
- `Plan/023-…/spec.md` + `agency/render.py:parse_slices` — render-slice
  contract.
- `Plan/inprogress/025-skill-first-discovery/spec.md` + `agency/render.py:render_phase`
  + `agency/capability.py:_wire_skill_tags` — Phase 1 foundations
  this spec consumes (commits `660d7f5`, `19058fe`).
- `Plan/inprogress/026-skills-as-core-capability/spec.md` v2 — defines the Matcher
