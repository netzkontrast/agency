...
wave: adr-workflow
affects:
  - Plan/done/354-adr-ontology-capability/spec.md
  - Plan/inprogress/355-adr-definition-of-done-gate/spec.md
  - Plan/inprogress/356-spec-decision-extraction/spec.md
  - Plan/inprogress/357-spec-state-lifecycle/spec.md
  - Plan/done/358-workflow-capability/spec.md
  - Plan/inprogress/359-brooks-lint/spec.md
---
