...
- Vision-alignment review (verdict NEEDS-MAJOR-REFRAME):
  `/home/user/agency/Plan/inprogress/011-agentic-capabilities/VISION-REVIEW.md` (per-verb rulings,
  MC1-MC7).
- Engineering review (kept realism): `/home/user/agency/Plan/inprogress/011-agentic-capabilities/REVIEW.md`
