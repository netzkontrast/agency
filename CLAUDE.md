...
| Review code quality (brooks Iron Law) | `develop.review(mode, scope)` interactive · `analyze.review(path, mode)` CI — guide `develop.reference("brooks")` | (eyeball — but lossy) |
