...
| **Drafted — next-wave roadmap (user-sketched 2026-06-06)** | 3 | **081 walkable-usage-skills** (every cap ships phase-graph skills teaching its MCP surface — NEXT) · 077 bdd-gherkin-tests (research-first) · 078 static-walkable-skills (research-first; needs clarification) |
