...
| **Partially implemented** | 10 | 007, 018, 024, 025, 026, 031, 041, 046, 093, 094 |
...
| 095 | music-lyrics-cluster | Draft | 14 user + 4 gate verbs covering 14 bitwize text/lyric tools + bitwize `voice-checker` skill ported as verb #14 (`check_voice_tells`); `lyric-writing` walkable skill with computed prosody/pronunciation/repetition/explicit gates | Driver-free transforms; deterministic; CI < 5s |
| 096 | music-audio-cluster | Draft | 19 user + 2 gate verbs covering 18 bitwize audio tools + bitwize `create_songbook` un-deferred as verb #19; `mastering` + `mix-polish` walkable skills; zero ffmpeg/pyloudnorm/AnthemScore in CI | The infrastructure-heavy cluster; production binds `[music-audio]` extra |
