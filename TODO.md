...
| 060 | templates-schemas-agent-instructions | In progress | Engine bootstrap wires load_capability_folders + 10+ capability folder-migrations + per-cap templates/schemas files + agent-instruction doctrine (Bitwize pattern) + `_check_template_folder` lint rule | Drafted 2026-06-03 — supersedes 032; absorbs 028 (jules folder); 7-phase plan (bootstrap → doctrine → roster → lint → verb migration → tests → review loop until clean) |
