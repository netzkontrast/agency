...
> **Milestone: ALL 5 leaf god-classes split + the spine ports (A1/A2/A3) done.** Full Engine build clean: 21 caps / 332 verbs, every verb-set unchanged. Remaining: A4 typed `Verb`, A5 substrate-tools-as-set, A7 `WireEnvelope`, Memory↔EntityStore (289 Slice 2b), `@requires_driver`, dedup.
