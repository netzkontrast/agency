...
> **Milestone: spine A1·A2·A3·A4·A5 + ALL 5 leaf splits + #8 done.** Full Engine build clean: 21 caps / 332 verbs (+7 substrate), wire byte-identical. Remaining: A7 `WireEnvelope.unwrap`, Memory↔EntityStore (289 Slice 2b, graph-authoritative mirror), capability-per-folder (`intent`/`shell`/`skills`, Goal 4), `@requires_driver`, dedup.
