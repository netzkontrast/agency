<!-- agency-generated: v1 -->
# Writing symbols verb descriptions
...
## symbols verb audit — 1 of 3 verbs need work

| Verb | Role | tool-desc flags |
|------|------|-----------------|
| `symbols.compress` | transform | ✓ clean |
| `symbols.expand` | transform | ✓ clean |
| `symbols.legend` | transform | `missing_inputs` |
