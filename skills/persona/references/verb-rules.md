<!-- agency-generated: v1 -->
# Writing persona verb descriptions
...
## persona verb audit — 2 of 3 verbs need work

| Verb | Role | tool-desc flags |
|------|------|-----------------|
| `persona.list` | act | `missing_inputs` |
| `persona.recommend` | act | `missing_inputs` |
| `persona.summon` | effect | ✓ clean |
