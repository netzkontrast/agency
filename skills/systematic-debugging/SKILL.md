...
Gather evidence at component boundaries, form one hypothesis, trace the data flow backward to the root cause, then fix and verify. Source: superpowers `systematic-debugging`. No cascading guesses.
