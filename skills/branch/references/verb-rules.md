<!-- agency-generated: v1 -->
# Writing branch verb descriptions
...
## branch verb audit — 0 of 3 verbs need work

| Verb | Role | tool-desc flags |
|------|------|-----------------|
| `branch.assess` | transform | ✓ clean |
| `branch.commit_smart` | transform | ✓ clean |
| `branch.finish` | effect | ✓ clean |
