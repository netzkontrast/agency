<!-- agency-generated: v1 -->
# Writing config verb descriptions
...
## config verb audit — 3 of 3 verbs need work

| Verb | Role | tool-desc flags |
|------|------|-----------------|
| `config.get` | act | `no_chain_next` |
| `config.list` | act | `missing_inputs`, `no_chain_next` |
| `config.set` | act | `no_chain_next` |
