...
- **dogfood** — apply_amendment, boundary_use_audit, collect, export, import, note, parse_amendment, recall_overflow_slice, record_decision, render, replay_events, spec_refs, spec_status, specs
...
- **manage** — amend, artefacts, create, list, open_intents, project, provenance, read, render, research_state, retract, state, subtree, timeline, update, whats_next
