...
- **novel** — analyze_readability, audit_novel_provenance, beta_ready_gate, capture_claim, capture_idea, chapter_report, check_approach_concern, check_content_warnings, check_crucial_element_placement, check_dialogue_attribution, check_dynamic_pair_reciprocity, check_filter_words, check_ktad_coverage, check_mental_sex_problem_solving, check_quad_completeness, check_resolve_outcome_judgment, check_show_dont_tell, check_signpost_permutation, check_slot_fill, check_storybeat_moment_refs, check_throughline_partition, conceptualize, count_words, create_chapter, create_novel, create_scene, dispatch_novel_research, find_novel, list_chapters, list_claims, list_ideas, manuscript_coherence_check, novel_coherence_check, novel_progress, pending_verifications, pre_draft_gate, promote_idea, publish_ready_gate, query_ready_gate, record_storyform_decision, rename_novel, render_blurb, render_chapter_brief, render_manuscript, render_query_letter, render_synopsis, resume_session, scan_proper_nouns, set_chapter_status, set_novel_status, storyform_critical_pass, validate_appreciations, validate_narrative_functions
...
- **prompt** — audit, audit_gate, brief_audit, brief_finalize, brief_render, catalog_list, engineer, fragment, fragments_for, intent_capture, register_fragment, token_budget_gate
