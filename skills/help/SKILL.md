...
- **adr** — approve, architecture, catalogue, dod_check, draft, extract_decisions, hints, impact, link, read, render, review_sweep, spec_decisions_ready, supersede, theme, theme_status, update, validate
