...
- **document** — compose, convergence, emit, explain, index_repo, ingest, mirror, render, reopen, restore_session, revisions, session, session_analytics, sync
...
- **loop** — add_criterion, add_member, advance, compile, critique_goal, detect_models, egress_consent, emit, emit_runner, frame_goal, open, preview, recommend_council, register_model, verify_report
...
- **novel** — add_alter, add_storyform_to_set, analyze_readability, anchor_beat, anchor_status_report, apply_structure, approve_canon, archive_codex_entry, assign_chapter_to_block, assign_voice_to_alter, audit_novel_provenance, beta_ready_gate, bridge_frequency_report, briefing_checklist, canon_audit, canon_gate, capture_claim, capture_idea, catalogue_query, chapter_report, chapter_report_full, check_alter_recognition, check_approach_concern, check_content_warnings, check_continuity, check_crucial_element_placement, check_dialogue_attribution, check_driver_transition_legality, check_dynamic_pair_reciprocity, check_filter_words, check_genre_bleed, check_klein_c_inversion, check_ktad_coverage, check_mental_sex_problem_solving, check_mode_vs_storyform_boundary, check_pov_consistency, check_pov_voice, check_quad_completeness, check_resolve_outcome_judgment, check_reveal_timing, check_sensitivity, check_show_dont_tell, check_signpost_permutation, check_slot_fill, check_storybeat_moment_refs, check_structure_coverage, check_throughline_partition, check_veil, check_voice_consistency, conceptualize, conflict_matrix_report, copy_gate, count_words, create_chapter, create_character_system, create_codex_entry, create_culture, create_language, create_magic_system, create_novel, create_religion, create_scene, create_storyform, create_storyform_set, create_voice_profile, create_world, create_world_axiom, define_mode_block, developmental_gate, dispatch_novel_research, dual_storyform_coherence_check, events_pov_witnessed, export_docx, export_epub, export_pdf, fetch_scene_body, find_axiom_contradictions, find_novel, flag_anachronistic_reference, generate_scene_body, get_storyform, get_structure_template, get_voice_profile, integrate_scene_body, leerstellen_report, line_gate, link_character_to_world, list_canon_proposals, list_chapters, list_claims, list_codex_entries, list_ideas, list_project_rules, list_reveals_in, list_story_events_up_to, list_structure_templates, list_world, lock_index, manuscript_coherence_check, mark_narrative_beat, match_codex_entries, mode_block_report, motif_echo_report, narrative_order, novel_coherence_check, novel_progress, pay_off_anchor, pending_verifications, plant_anchor, pov_options, pre_draft_gate, preflight_readiness, preflight_report, project_rule_gate, promote_from_quarry, promote_idea, propose_canon, publication_gate, publish_ready_gate, quarry_filter, query_co_front, query_phobia_cycles, query_ready_gate, reader_function_audit, record_alter_conflict, record_character_learns, record_leerstelle, record_lock, record_motif_echo, record_story_event, record_storyform_decision, record_storyform_transition, register_project_rule, rename_novel, render_all, render_blurb, render_chapter_brief, render_chapter_briefing, render_manuscript, render_query_letter, render_synopsis, resolve_canon_conflict, resume_session, reveal_gate, reveal_in_scene, reveal_timeline_report, route_scene_storyform, run_project_rules, scan_proper_nouns, score_voice_match, set_canon_status, set_chapter_status, set_novel_status, set_reveal_rule, story_time_query, storyform_critical_pass, structure_position_report, switching_log, update_codex_entry, update_voice_profile, validate_appreciations, validate_narrative_functions, validate_no_fusion, voice_drift_gate, voice_drift_report, what_does_X_know_as_of
- **panel** — convene, experts
- **persona** — list, recommend, summon
- **plugin** — author_command, author_skill, help, lint_capability, lint_disciplines, lint_explain, lint_skill, lint_skill_schema, marketplace_entry, publish_skill, scaffold, step_doc
- **prompt** — assemble_scene_brief, audit, audit_gate, brief_audit, brief_finalize, brief_render, catalog_list, compose_drafting_brief, compose_voice_locked_brief, engineer, evaluate, exemplar_pool, fragment, fragments_for, fragments_for_scope, framework, frameworks_for, intent_capture, register_fragment, register_framework, render, route_framework, token_budget_gate, voice_drift_audit
- **recommend** — route
...
- **workflow** — approve_decisions, begin_impl, board, finish_spec, index, mark_done, move_spec, open_spec, to_open
