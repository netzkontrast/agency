...
- **develop** — checklist, draft_plan, estimate, index, mode_select, plan_status, port_plugin, record_authoring_outcome, record_step_outcome, reference, scaffold_capability, session_check, session_init, session_resume, skill_walk, validate_skill
- **document** — convergence, explain, index_repo, ingest, render, reopen, restore_session, revisions, session, session_analytics, sync
...
- **manage** — amend, create, list, read, retract, update
