...
- **adr** — approve, dod_check, draft, extract_decisions, hints, impact, link, read, render, spec_decisions_ready, supersede, theme, theme_status, update, validate
...
- **workflow** — board, move_spec, open_spec
