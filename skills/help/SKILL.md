...
- **gate** — check
- **intent** — apply_full_review, assumptions, decompose, first_principles, inversion, premortem, red_team, second_order, socratic, steelman, suggests, tradeoffs
