...
- **novel** — analyze_readability, audit_novel_provenance, beta_ready_gate, capture_claim, capture_idea, chapter_report, chapter_report_full, check_approach_concern, check_content_warnings, check_continuity, check_crucial_element_placement, check_dialogue_attribution, check_dynamic_pair_reciprocity, check_filter_words, check_ktad_coverage, check_mental_sex_problem_solving, check_pov_consistency, check_quad_completeness, check_resolve_outcome_judgment, check_sensitivity, check_show_dont_tell, check_signpost_permutation, check_slot_fill, check_storybeat_moment_refs, check_throughline_partition, check_voice_consistency, conceptualize, copy_gate, count_words, create_chapter, create_culture, create_language, create_magic_system, create_novel, create_religion, create_scene, create_world, create_world_axiom, developmental_gate, dispatch_novel_research, export_docx, export_epub, export_pdf, find_axiom_contradictions, find_novel, line_gate, link_character_to_world, list_chapters, list_claims, list_ideas, list_reveals_in, list_story_events_up_to, list_world, manuscript_coherence_check, mark_narrative_beat, narrative_order, novel_coherence_check, novel_progress, pending_verifications, pre_draft_gate, promote_idea, publication_gate, publish_ready_gate, query_ready_gate, record_story_event, record_storyform_decision, rename_novel, render_blurb, render_chapter_brief, render_manuscript, render_query_letter, render_synopsis, resume_session, reveal_in_scene, scan_proper_nouns, set_chapter_status, set_novel_status, storyform_critical_pass, validate_appreciations, validate_narrative_functions
