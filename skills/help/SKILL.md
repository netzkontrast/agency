...
- **music** — album_progress, analyze_mix, analyze_readability, analyze_rhyme_scheme, capture_idea, catalogue_status, check_cross_track_repetition, check_explicit_content, check_homographs, check_pronunciation, check_streaming_lyrics, check_voice_tells, conceptualize, count_syllables, create_album, create_track, explicit_gate, extract_distinctive_phrases, extract_section, find_album, list_ideas, list_tracks, lyric_report, master_album, music_health, pregen_check, promo_copy, promote_idea, pronunciation_gate, prosody_gate, publish_asset, release_check, rename_album, rename_track, repetition_gate, resume_session, scan_artist_names, set_album_status, set_track_status, transcribe_sheet, validate_section_structure, verify_streaming
