...
- **music** — album_progress, analyze_mix, capture_idea, catalogue_status, conceptualize, count_syllables, create_album, create_track, find_album, format_clipboard, get_config, get_reference, list_ideas, list_tracks, load_override, lyric_report, master_album, music_health, pregen_check, promo_copy, promote_idea, publish_asset, release_check, rename_album, rename_track, resume_session, set_album_status, set_track_status, transcribe_sheet, verify_streaming
