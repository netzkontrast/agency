...
- **novel** — capture_idea, chapter_report, check_quad_completeness, check_throughline_partition, conceptualize, create_chapter, create_novel, find_novel, list_ideas, promote_idea, render_manuscript, set_novel_status
