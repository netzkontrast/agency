...
- **novel** — analyze_readability, capture_idea, chapter_report, check_filter_words, check_throughline_partition, conceptualize, count_words, create_chapter, create_novel, find_novel, list_ideas, promote_idea, render_manuscript, set_novel_status
