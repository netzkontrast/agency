...
- **music** — album_coherence_check, album_coherence_correct, album_progress, analyze_audio, analyze_mix, analyze_readability, analyze_rhyme_scheme, capture_idea, catalogue_status, check_cross_track_repetition, check_explicit_content, check_homographs, check_pronunciation, check_streaming_lyrics, check_voice_tells, conceptualize, count_syllables, create_album, create_songbook, create_track, explicit_gate, extract_distinctive_phrases, extract_section, find_album, fix_dynamic_track, generate_promo_videos, list_ideas, list_tracks, lyric_report, master_album, master_audio, master_with_reference, measure_album_signature, measure_gate, mono_fold_check, music_health, polish_album, polish_and_master_album, polish_audio, pregen_check, promo_copy, promote_idea, pronunciation_gate, prosody_gate, publish_asset, qc_audio, qc_gate, release_check, rename_album, rename_track, render_codec_preview, repetition_gate, reset_mastering, resume_session, scan_artist_names, set_album_status, set_track_status, transcribe_sheet, validate_section_structure, verify_streaming
