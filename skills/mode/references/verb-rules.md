<!-- agency-generated: v1 -->
# Writing mode verb descriptions
...
## mode verb audit — 2 of 3 verbs need work

| Verb | Role | tool-desc flags |
|------|------|-----------------|
| `mode.activate` | effect | ✓ clean |
| `mode.detect` | act | `missing_inputs` |
| `mode.list` | act | `missing_inputs` |
