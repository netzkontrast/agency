<!-- agency-generated: v1 -->
# Writing delegate verb descriptions
...
## delegate verb audit — 0 of 4 verbs need work

| Verb | Role | tool-desc flags |
|------|------|-----------------|
| `delegate.dispatch_bash_hints` | transform | ✓ clean |
| `delegate.dispatch_decision` | transform | ✓ clean |
| `delegate.fan_out` | effect | ✓ clean |
| `delegate.join` | act | ✓ clean |
