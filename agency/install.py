...
CMD_BODY = (
    ...
    "(micro-skills). Bootstrap an intent, then call the help verb with its id:\n\n"
    "    iid=$(python -m agency.cli --db agency.db intent --purpose help "
    "--deliverable map --acceptance ok | python -c "
