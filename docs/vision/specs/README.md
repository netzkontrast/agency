...
| [superpowers-port](superpowers-port.md) | DRAFT — the complete port of the superpowers plugin into Agency (every skill → a gated `develop` skill, a capability verb, or a composition) |
