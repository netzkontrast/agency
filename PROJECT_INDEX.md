...
actually happened, which is worse than a larger record.
...
- **_session_snapshot.py** — Session-graph snapshot — portable SQLModel export/import (user directive 2026-06-19).
